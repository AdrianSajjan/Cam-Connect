...
const NavigationListItem = React.forwardRef<HTMLAnchorElement, Omit<React.ComponentPropsWithoutRef<"a">, "href"> & { href: Url }>(
  ({ className, title, children, href, ...props }, ref) => {
    return (
      <li>
        <Link ref={ref} href={href} {...props} legacyBehavior passHref>
          <NavigationMenuLink
            className={cn(
...
const navigationMenuClassName = navigationMenuTriggerStyle();
