...
const FormDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement> & { error?: "hidden" | "show" }>(
  ({ className, error: _error = "hidden", ...props }, ref) => {
    const { formDescriptionId, error } = useFormField();
    if (error && _error === "hidden") {
      return null;
    }
